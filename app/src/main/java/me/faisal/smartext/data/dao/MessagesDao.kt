package me.faisal.smartext.data.dao
...
import me.faisal.smartext.data.entities.MessageState
import me.faisal.smartext.data.entities.MessageWithRecipients
import me.faisal.smartext.data.entities.MessagesStats
import me.faisal.smartext.data.entities.MessagesTotals
import me.faisal.smartext.data.entities.RecipientState
...
interface MessagesDao {
    ...
    fun _insertRecipientStatesByMessage(
        messageId: String,
        state: me.faisal.smartext.domain.ProcessingState
    )
    ...
    fun _updateMessageState(id: String, state: me.faisal.smartext.domain.ProcessingState)

    fun updateMessageState(id: String, state: me.faisal.smartext.domain.ProcessingState) {
    ...
    fun setMessageProcessed(id: String) {
        ...
        _insertMessageState(
            MessageState(
                id,
                me.faisal.smartext.domain.ProcessingState.Processed,
                System.currentTimeMillis()
            )
        )
    }
