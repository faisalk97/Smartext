package me.faisal.smartext.ui.adapters
...
import me.faisal.smartext.databinding.ItemWebhookBinding
import me.faisal.smartext.modules.webhooks.domain.WebHookDTO
        ...
        fun bind(webhook: WebHookDTO) {
            binding.apply {
                ...
                sourceText.text = when (webhook.source) {
                    me.faisal.smartext.domain.EntitySource.Local -> binding.root.context.getString(
                        R.string.local
                    )

                    me.faisal.smartext.domain.EntitySource.Gateway,
                    me.faisal.smartext.domain.EntitySource.Cloud -> binding.root.context.getString(
                        R.string.cloud
                    )
                }
                sourceIcon.setImageResource(
                    when (webhook.source) {
                        me.faisal.smartext.domain.EntitySource.Local -> R.drawable.ic_local_server
                        me.faisal.smartext.domain.EntitySource.Cloud,
                        me.faisal.smartext.domain.EntitySource.Gateway -> R.drawable.ic_cloud_server
                    }
                )
            }
        }
