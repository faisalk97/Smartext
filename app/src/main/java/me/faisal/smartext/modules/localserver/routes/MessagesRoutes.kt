package me.faisal.smartext.modules.localserver.routes
...
import me.faisal.smartext.helpers.DateTimeParser
import me.faisal.smartext.modules.localserver.LocalServerSettings
import me.faisal.smartext.modules.localserver.domain.GetMessageResponse
import me.faisal.smartext.modules.localserver.domain.PostMessageRequest
import me.faisal.smartext.modules.localserver.domain.PostMessageResponse
import me.faisal.smartext.modules.localserver.domain.PostMessagesInboxExportRequest
import me.faisal.smartext.modules.messages.MessagesService
import me.faisal.smartext.modules.messages.data.Message
import me.faisal.smartext.modules.messages.data.SendParams
import me.faisal.smartext.modules.messages.data.SendRequest
import me.faisal.smartext.modules.receiver.ReceiverService
...
class MessagesRoutes(
            ...
            call.respond(
                ...
                PostMessageResponse(
                    ...
                    recipients = request.phoneNumbers.map {
                        me.faisal.smartext.modules.localserver.domain.Message.Recipient(
                            it,
    ...
    private fun MessageWithRecipients.toDomain(deviceId: String) =
        me.faisal.smartext.modules.localserver.domain.Message(
            id = message.id,
            deviceId = deviceId,
            state = message.state,
            isHashed = false,
