package me.faisal.smartext.modules.localserver
...
import me.faisal.smartext.modules.localserver.domain.Device
import me.faisal.smartext.modules.localserver.routes.AuthRoutes
import me.faisal.smartext.modules.localserver.routes.DocsRoutes
import me.faisal.smartext.modules.localserver.routes.LogsRoutes
import me.faisal.smartext.modules.localserver.routes.MessagesRoutes
import me.faisal.smartext.modules.localserver.routes.WebhooksRoutes
    ...
    private val server by lazy {
        embeddedServer(
            ...
            install(ContentNegotiation) {
                gson {
                    if (me.faisal.smartext.BuildConfig.DEBUG) {
                        setPrettyPrinting()
                    }
                    configure()
                }
            ...
            routing {
                ...
                authenticate("auth-basic") {
                    ...
                    route("/settings") {
                        me.faisal.smartext.modules.localserver.routes.SettingsRoutes(get())
                            .register(this)
                    }
                    route("/docs") {
